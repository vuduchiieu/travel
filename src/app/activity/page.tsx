  ...
  return (
    <>
      ...
      <div className=" flex items-center w-screen">
        <nav className="flex py-[4px] px-[16px] h-[42px] min-w mt-[74px] mx-auto ">
          <button className="h-[34px] min-w-[100px] border-[1px] bg-[#000] border-solid boder-[#00000066] px-[16px] mr-[8px] rounded-[10px] ">
            <p className="text-[#fff] font-semibold ">Tất cả</p>
          </button>
          <button className="h-[34px] min-w-[100px] border-[1px] border-solid boder-[#00000066] px-[16px] mr-[8px] rounded-[10px] ">
